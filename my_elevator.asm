;
; CopyRight (C) 2019 CyFio OranGeÃ¢â€?
...
str_arrival     db      'elevator arrival!                        ', 0dh, '$'
str_continue    db      'elevator continues!                      ',0dh,'$'
str_pause       db      'elevator paused!                         ',0dh,'$'
str_start       db      'elevator starts!                         ',0dh,'$'
str_stop        db      'elevator stops!                          ',0dh,'$'
str_direct_st   db      'elevator direct mode: on                 ',0dh,'$'
str_direct_ed   db      'elevator direct mode: off                ',0dh,'$'
...
oled_repair     db   00h ,00h ,00h ,0fbh,0fbh,00h ,00h ,00h
...
elevator_pause_loop_continue:
    call far ptr oled_update
    jmp elevator_pause_loop
    jmp exit
...
key_update_d:
    ...
    mov is_ignore, bl
    cmp bl, true
    jnz key_update_direct_off
key_update_direct_on:
    mov dx, offset str_direct_st
    jmp key_update_direct_show
key_update_direct_off:
    mov dx, offset str_direct_ed
key_update_direct_show:
    call far ptr print_str
key_update_p:   
    cmp al, key_pause
    jnz key_update_ret
...
elevator_arrival proc far ;elevator arrive
    ...
    mov al, is_ignore
    cmp al, true
    jnz elevator_arrival_stop
    mov al, level_select
    cmp al, 0
    jz elevator_arrival_stop
    jmp elevator_arrival_direct
elevator_arrival_stop:
    mov al, false
    mov is_running, al
    mov dx,io8254c;8254 Timer1->function3 
    mov al,76h
    out dx,al 
elevator_arrival_direct:
